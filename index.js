...
console.log(chalk.blue('supreme-cli start...'));
...
exec("git clone https://git.nevint.com/arthur/supreme.git",function(error){
  if(!error){
          ...
          if(filePath.indexOf(".git")==-1){
            copydir(filePath,path.join(process.cwd(),file),function(err){
              ...
              if(loop==files.length-1){
                console.log(chalk.green('supreme install has success...'));
